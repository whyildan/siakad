...
@section('content-page')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Manajemen Data Jurnal Pembelajaran</h4>
        <div class="card">
            <div class="card-header d-flex justify-content-end">
                <button type="button" class="btn btn-primary"><a href="{{ url('/addjournal') }}"
                        class="text-white text-decoration-none">Tambah Jurnal</a></button>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-warning"><a
                                        class="text-white text-decoration-none" href="{{ url('/editjournal') }}"><i
